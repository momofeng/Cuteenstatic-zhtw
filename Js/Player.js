...
var _createClass = function () {
	...
	CTPlayer = function () {
		function a(b) {
			var c = this;
			if (_classCallCheck(this, a), instance) return console.error("只能存在一個實例！"), Object.create(null);
			instance = !0;
			...
			if (this.option = b, !(this.option.music && this.option.music.type && this.option.music.source)) return console.error("請正確配置對象！"), Object.create(null);
